    ...
    <footer className="border-t border-stone-800 bg-stone-950 text-stone-400 py-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs"><li><Link href="/recomendador" className="hover:text-amber-400">Asistente de Setup Ideal</Link></li><li><Link href="/comparativas" className="hover:text-amber-400">Matriz de Comparativas</Link></li><li><Link href="/cafes" className="hover:text-amber-400">Catálogo de Granos Curados</Link></li></ul>
        </div>
        <div>
          <h4 className="font-semibold text-stone-200 mb-2">Conocimiento</h4>
          <ul className="space-y-2 text-xs"><li><Link href="/guias" className="hover:text-amber-400">Portafiltros: 54mm vs 58mm</Link></li><li><Link href="/guias" className="hover:text-amber-400">Sistemas de Calentamiento</Link></li><li><Link href="/metodologia" className="hover:text-amber-400">Metodología de Scoring</Link></li></ul>
        </div>
        <div>
          <h4 className="font-semibold text-stone-200 mb-2">Transparencia</h4>
          <ul className="space-y-2 text-xs"><li><Link href="/afiliados" className="hover:text-amber-400">Aviso de Afiliación (Amazon 5%)</Link></li><li><Link href="/metodologia" className="hover:text-amber-400">Verificación de Fuentes</Link></li></ul>
        </div>
      </div>
