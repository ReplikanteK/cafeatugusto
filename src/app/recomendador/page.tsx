...
const ARCHETYPE_PRESETS: Record<string, UserPreferences> = {
  precisionist: { drinkTypes: ["espresso"], budgetMaxEUR: 1200, workflowPreference: "manual_craft", dailyCups: "3-5", milkImportance: "low", maintenanceTolerance: "medium", spaceConstraint: false, integratedGrinderPreference: "separated" },
